...
void DisplayStandard::printScreen(MachineState machineState, double temperature, double setpoint, unsigned int isrCounter, BrewSwitchState brewSwitchState) {
    if (!display_enabled) {
        return;
    }
